...
The library can be installed using:
	...
	go get -u github.com/theidexisted/activity-tracker
...
Check out the example here : https://github.com/theidexisted/activity-tracker/blob/master/example/example.go
*/
package main
